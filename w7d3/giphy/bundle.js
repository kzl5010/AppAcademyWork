...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.receiveSearchGiphys = exports.fetchSearchGiphys = exports.REQUEST_SEARCH_GIFS = exports.RECEIVE_SEARCH_GIFS = undefined;
	...
	var RECEIVE_SEARCH_GIFS = exports.RECEIVE_SEARCH_GIFS = 'RECEIVE_SG';
	var REQUEST_SEARCH_GIFS = exports.REQUEST_SEARCH_GIFS = 'REQUEST_SG';
	
	var fetchSearchGiphys = exports.fetchSearchGiphys = function fetchSearchGiphys(term) {
	  return function (dispatch) {
	    APIUtil.fetchSearchGiphys(term).then(function (gifs) {
	      return dispatch(receiveSearchGiphys(gifs.data));
	    });
	  };
	};
	
	var receiveSearchGiphys = exports.receiveSearchGiphys = function receiveSearchGiphys(gifs) {
	  return {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _giphys_search = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./giphys_search\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	  return {
	    fetchSearchGiphys: function fetchSearchGiphys(term) {
	      return dispatch((0, _giphy_actions.fetchSearchGiphys)(term));
	    }
	  };
	};
